...
// namespace io
// {
// HikRobot::HikRobot(double exposure_ms, double gain, const std::string &
// vid_pid) : exposure_us_(exposure_ms * 1e3), gain_(gain), queue_(1),
...
// }
//
// void HikRobot::read(cv::Mat & img, std::chrono::steady_clock::time_point &
// timestamp)
// {
//   CameraData data;
//   queue_.pop(data);
...
//       cv::Mat dst_image;
//       const static std::unordered_map<MvGvspPixelType,
...
//
//   if (ret != MV_OK) {
//     tools::logger()->warn("MV_CC_SetFloatValue(\"{}\", {}) failed: {:#x}",
//     name, value, ret); return;
//   }
// }
//
...
//
//   if (ret != MV_OK) {
//     tools::logger()->warn("MV_CC_SetEnumValue(\"{}\", {}) failed: {:#x}",
//     name, value, ret); return;
//   }
// }
//
