...
typedef enum GX_STATUS_LIST {
  ...
  GX_STATUS_NEED_MORE_BUFFER =
      -9, ///< 用户申请的buffer不足:读操作时用户输入buffersize小于实际需要
  GX_STATUS_ERROR_TYPE =
      -10, ///< 用户使用的FeatureID类型错误，比如整型接口使用了浮点型的功能码
...
typedef enum GX_FEATURE_ID {
  ...
  GX_STRING_DEVICE_VENDOR_NAME =
      0 | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 厂商名称
  GX_STRING_DEVICE_MODEL_NAME =
      1 | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 设备型号
  GX_STRING_DEVICE_FIRMWARE_VERSION =
      2 | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 设备固件版本
  GX_STRING_DEVICE_VERSION =
      3 | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 设备版本
  GX_STRING_DEVICE_SERIAL_NUMBER =
      4 | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 设备序列号
  GX_STRING_FACTORY_SETTING_VERSION =
      6 | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 出厂参数版本
  GX_STRING_DEVICE_USERID =
      7 | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 用户自定义名称
  GX_INT_DEVICE_LINK_SELECTOR =
      8 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 设备链路选择
  GX_ENUM_DEVICE_LINK_THROUGHPUT_LIMIT_MODE =
      9 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 设备带宽限制模式，参考GX_DEVICE_LINK_THROUGHPUT_LIMIT_MODE_ENTRY
  GX_INT_DEVICE_LINK_THROUGHPUT_LIMIT =
      10 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 设备链路带宽限制
  GX_INT_DEVICE_LINK_CURRENT_THROUGHPUT =
      11 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 当前设备采集带宽
  GX_COMMAND_DEVICE_RESET =
      12 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 设备复位
  GX_INT_TIMESTAMP_TICK_FREQUENCY =
      13 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 时间戳频率
  GX_COMMAND_TIMESTAMP_LATCH =
      14 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 时间戳锁存
  GX_COMMAND_TIMESTAMP_RESET =
      15 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 重置时间戳
  GX_COMMAND_TIMESTAMP_LATCH_RESET =
      16 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 重置时间戳锁存
  GX_INT_TIMESTAMP_LATCH_VALUE =
      17 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 时间戳锁存值

  //---------------ImageFormat Section--------------------------------
  GX_INT_SENSOR_WIDTH =
      1000 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 传感器宽度
  GX_INT_SENSOR_HEIGHT =
      1001 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 传感器高度
  GX_INT_WIDTH_MAX =
      1002 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 最大宽度
  GX_INT_HEIGHT_MAX =
      1003 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 最大高度
  GX_INT_OFFSET_X =
      1004 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 水平偏移
  GX_INT_OFFSET_Y =
      1005 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 垂直偏移
  GX_INT_WIDTH =
      1006 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 图像宽度
  GX_INT_HEIGHT =
      1007 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 图像高度
  GX_INT_BINNING_HORIZONTAL =
      1008 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 水平像素Binning
  GX_INT_BINNING_VERTICAL =
      1009 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 垂直像素Binning
  GX_INT_DECIMATION_HORIZONTAL =
      1010 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 水平像素抽样
  GX_INT_DECIMATION_VERTICAL =
      1011 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 垂直像素抽样
  GX_ENUM_PIXEL_SIZE =
      1012 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 像素位深,参考GX_PIXEL_SIZE_ENTRY
  GX_ENUM_PIXEL_COLOR_FILTER =
      1013 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< Bayer格式,参考GX_PIXEL_COLOR_FILTER_ENTRY
  GX_ENUM_PIXEL_FORMAT =
      1014 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 像素格式,参考GX_PIXEL_FORMAT_ENTRY
  GX_BOOL_REVERSE_X =
      1015 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 水平翻转
  GX_BOOL_REVERSE_Y =
      1016 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 垂直翻转
  GX_ENUM_TEST_PATTERN =
      1017 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 测试图,参考GX_TEST_PATTERN_ENTRY
  GX_ENUM_TEST_PATTERN_GENERATOR_SELECTOR =
      1018 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 测试图源选择，参考GX_TEST_PATTERN_GENERATOR_SELECTOR_ENTRY
  GX_INT_CENTER_WIDTH =
      1022 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 窗口宽度
  GX_INT_CENTER_HEIGHT =
      1023 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 窗口高度
  GX_ENUM_BINNING_HORIZONTAL_MODE =
      1024 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 水平像素Binning模式,参考GX_BINNING_HORIZONTAL_MODE_ENTRY
  GX_ENUM_BINNING_VERTICAL_MODE =
      1025 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 垂直像素Binning模式,参考GX_BINNING_VERTICAL_MODE_ENTRY

  //---------------TransportLayer Section-------------------------------
  GX_INT_PAYLOAD_SIZE =
      2000 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 数据大小
  GX_BOOL_GEV_CURRENT_IPCONFIGURATION_LLA =
      2001 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< LLA方式配置IP
  GX_BOOL_GEV_CURRENT_IPCONFIGURATION_DHCP =
      2002 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< DHCP方式配置IP
  GX_BOOL_GEV_CURRENT_IPCONFIGURATION_PERSISTENTIP =
      2003 | GX_FEATURE_BOOL |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 永久IP方式配置IP
  GX_INT_ESTIMATED_BANDWIDTH =
      2004 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 预估带宽，单位Bps(Bytes per second)
  GX_INT_GEV_HEARTBEAT_TIMEOUT =
      2005 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 心跳超时时间
  GX_INT_GEV_PACKETSIZE =
      2006 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 流通道包长
  GX_INT_GEV_PACKETDELAY =
      2007 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 流通道包间隔
  GX_INT_GEV_LINK_SPEED =
      2008 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 连接速度

  //---------------AcquisitionTrigger Section---------------------------
  GX_ENUM_ACQUISITION_MODE =
      3000 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 采集模式,参考GX_ACQUISITION_MODE_ENTRY
  GX_COMMAND_ACQUISITION_START =
      3001 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 开始采集
  GX_COMMAND_ACQUISITION_STOP =
      3002 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 停止采集
  GX_INT_ACQUISITION_SPEED_LEVEL =
      3003 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 采集速度级别
  GX_INT_ACQUISITION_FRAME_COUNT =
      3004 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 多帧采集帧数
  GX_ENUM_TRIGGER_MODE =
      3005 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 触发模式,参考GX_TRIGGER_MODE_ENTRY
  GX_COMMAND_TRIGGER_SOFTWARE =
      3006 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 软触发
  GX_ENUM_TRIGGER_ACTIVATION =
      3007 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 触发极性,参考GX_TRIGGER_ACTIVATION_ENTRY
  GX_ENUM_TRIGGER_SWITCH =
      3008 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 外触发开关,参考GX_TRIGGER_SWITCH_ENTRY
  GX_FLOAT_EXPOSURE_TIME =
      3009 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 曝光时间
  GX_ENUM_EXPOSURE_AUTO =
      3010 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动曝光,参考GX_EXPOSURE_AUTO_ENTRY
  GX_FLOAT_TRIGGER_FILTER_RAISING =
      3011 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 上升沿触发滤波
  GX_FLOAT_TRIGGER_FILTER_FALLING =
      3012 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 下降沿触发滤波
  GX_ENUM_TRIGGER_SOURCE =
      3013 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 触发源,参考GX_TRIGGER_SOURCE_ENTRY
  GX_ENUM_EXPOSURE_MODE =
      3014 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 曝光模式，参考GX_EXPOSURE_MODE_ENTRY
  GX_ENUM_TRIGGER_SELECTOR =
      3015 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 触发类型选择，参考GX_TRIGGER_SELECTOR_ENTRY
  GX_FLOAT_TRIGGER_DELAY =
      3016 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 触发延迟
  GX_ENUM_TRANSFER_CONTROL_MODE =
      3017 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 传输控制模式，参考GX_TRANSFER_CONTROL_MODE_ENTRY
  GX_ENUM_TRANSFER_OPERATION_MODE =
      3018 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 传输操作模式，参考GX_TRANSFER_OPERATION_MODE_ENTRY
  GX_COMMAND_TRANSFER_START =
      3019 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 开始传输
  GX_INT_TRANSFER_BLOCK_COUNT =
      3020 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 传输帧数。当GX_ENUM_TRANSFER_OPERATION_MODE设置为GX_ENUM_TRANSFER_OPERATION_MODE_MULTIBLOCK模式的时候此功能被激活
  GX_BOOL_FRAMESTORE_COVER_ACTIVE =
      3021 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 帧存覆盖使能
  GX_ENUM_ACQUISITION_FRAME_RATE_MODE =
      3022 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 采集帧率调节模式，参考GX_ACQUISITION_FRAME_RATE_MODE_ENTRY
  GX_FLOAT_ACQUISITION_FRAME_RATE =
      3023 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 采集帧率
  GX_FLOAT_CURRENT_ACQUISITION_FRAME_RATE =
      3024 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 当前采集帧率
  GX_ENUM_FIXED_PATTERN_NOISE_CORRECT_MODE =
      3025 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 模板噪声校正，参考GX_FIXED_PATTERN_NOISE_CORRECT_MODE
  GX_INT_ACQUISITION_BURST_FRAME_COUNT =
      3030 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 高速连拍帧数
  GX_ENUM_ACQUISITION_STATUS_SELECTOR =
      3031 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 采集状态选择,参考GX_ACQUISITION_STATUS_SELECTOR_ENTRY
  GX_BOOL_ACQUISITION_STATUS =
      3032 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 采集状态
  GX_FLOAT_EXPOSURE_DELAY =
      30300 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 曝光延迟

  //----------------DigitalIO Section----------------------------------
  GX_ENUM_USER_OUTPUT_SELECTOR =
      4000 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 用户自定义输出选择,参考GX_USER_OUTPUT_SELECTOR_ENTRY
  GX_BOOL_USER_OUTPUT_VALUE = 4001 | GX_FEATURE_BOOL |
                              GX_FEATURE_LEVEL_REMOTE_DEV, ///< 用户自定义输出值
  GX_ENUM_USER_OUTPUT_MODE =
      4002 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 用户IO输出模式,参考GX_USER_OUTPUT_MODE_ENTRY
  GX_ENUM_STROBE_SWITCH =
      4003 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 闪光灯开关,参考GX_STROBE_SWITCH_ENTRY
  GX_ENUM_LINE_SELECTOR =
      4004 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 引脚选择,参考GX_LINE_SELECTOR_ENTRY
  GX_ENUM_LINE_MODE =
      4005 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 引脚方向,参考GX_LINE_MODE_ENTRY
  GX_BOOL_LINE_INVERTER =
      4006 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 引脚电平反转
  GX_ENUM_LINE_SOURCE =
      4007 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 引脚输出源,参考GX_LINE_SOURCE_ENTRY
  GX_BOOL_LINE_STATUS =
      4008 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 引脚状态
  GX_INT_LINE_STATUS_ALL =
      4009 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 所有引脚的状态

  //----------------AnalogControls Section----------------------------
  GX_ENUM_GAIN_AUTO =
      5000 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动增益,参考GX_GAIN_AUTO_ENTRY
  GX_ENUM_GAIN_SELECTOR =
      5001 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 增益通道选择,参考GX_GAIN_SELECTOR_ENTRY
  GX_ENUM_BLACKLEVEL_AUTO =
      5003 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动黑电平,参考GX_BLACKLEVEL_AUTO_ENTRY
  GX_ENUM_BLACKLEVEL_SELECTOR =
      5004 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 黑电平通道选择,参考GX_BLACKLEVEL_SELECTOR_ENTRY
  GX_ENUM_BALANCE_WHITE_AUTO =
      5006 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动白平衡,参考GX_BALANCE_WHITE_AUTO_ENTRY
  GX_ENUM_BALANCE_RATIO_SELECTOR =
      5007 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 白平衡通道选择,参考GX_BALANCE_RATIO_SELECTOR_ENTRY
  GX_FLOAT_BALANCE_RATIO =
      5008 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 白平衡系数
  GX_ENUM_COLOR_CORRECT =
      5009 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 颜色校正,参考GX_COLOR_CORRECT_ENTRY
  GX_ENUM_DEAD_PIXEL_CORRECT =
      5010 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 坏点校正,参考GX_DEAD_PIXEL_CORRECT_ENTRY
  GX_FLOAT_GAIN =
      5011 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 增益
  GX_FLOAT_BLACKLEVEL =
      5012 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 黑电平
  GX_BOOL_GAMMA_ENABLE =
      5013 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Gamma使能
  GX_ENUM_GAMMA_MODE =
      5014 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< Gamma模式,参考GX_GAMMA_MODE_ENTRY
  GX_FLOAT_GAMMA =
      5015 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Gamma
  GX_INT_DIGITAL_SHIFT =
      5016 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 数字移位

  //---------------CustomFeature Section-------------------------
  GX_INT_ADC_LEVEL =
      6000 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< AD转换级别
  GX_INT_H_BLANKING =
      6001 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 水平消隐
  GX_INT_V_BLANKING =
      6002 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 垂直消隐
  GX_STRING_USER_PASSWORD = 6003 | GX_FEATURE_STRING |
                            GX_FEATURE_LEVEL_REMOTE_DEV, ///< 用户加密区密码
  GX_STRING_VERIFY_PASSWORD =
      6004 | GX_FEATURE_STRING |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 用户加密区校验密码
  GX_BUFFER_USER_DATA = 6005 | GX_FEATURE_BUFFER |
                        GX_FEATURE_LEVEL_REMOTE_DEV, ///< 用户加密区内容
  GX_INT_GRAY_VALUE =
      6006 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 期望灰度值
  GX_ENUM_AA_LIGHT_ENVIRONMENT =
      6007 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动曝光、自动增益，光照环境类型,参考GX_AA_LIGHT_ENVIRMENT_ENTRY
  GX_INT_AAROI_OFFSETX =
      6008 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动调节感兴趣区域X坐标
  GX_INT_AAROI_OFFSETY =
      6009 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动调节感兴趣区域Y坐标
  GX_INT_AAROI_WIDTH = 6010 | GX_FEATURE_INT |
                       GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动调节感兴趣区域宽度
  GX_INT_AAROI_HEIGHT = 6011 | GX_FEATURE_INT |
                        GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动调节感兴趣区域高度
  GX_FLOAT_AUTO_GAIN_MIN =
      6012 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动增益最小值
  GX_FLOAT_AUTO_GAIN_MAX =
      6013 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动增益最大值
  GX_FLOAT_AUTO_EXPOSURE_TIME_MIN =
      6014 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动曝光最小值
  GX_FLOAT_AUTO_EXPOSURE_TIME_MAX =
      6015 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动曝光最大值
  GX_BUFFER_FRAME_INFORMATION =
      6016 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 图像帧信息
  GX_INT_CONTRAST_PARAM =
      6017 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 对比度参数
  GX_FLOAT_GAMMA_PARAM =
      6018 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 伽马参数
  GX_INT_COLOR_CORRECTION_PARAM =
      6019 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 颜色校正系数
  GX_ENUM_IMAGE_GRAY_RAISE_SWITCH =
      6020 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 图像亮度拉伸开关,参考GX_IMAGE_GRAY_RAISE_SWITCH_ENTRY
  GX_ENUM_AWB_LAMP_HOUSE =
      6021 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动白平衡光源,参考GX_AWB_LAMP_HOUSE_ENTRY
  GX_INT_AWBROI_OFFSETX =
      6022 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动白平衡感兴趣区域X坐标
  GX_INT_AWBROI_OFFSETY =
      6023 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动白平衡感兴趣区域Y坐标
  GX_INT_AWBROI_WIDTH =
      6024 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动白平衡感兴趣区域宽度
  GX_INT_AWBROI_HEIGHT =
      6025 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动白平衡感兴趣区域高度
  GX_ENUM_SHARPNESS_MODE =
      6026 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 锐化模式,参考GX_SHARPNESS_MODE_ENTRY
  GX_FLOAT_SHARPNESS =
      6027 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 锐度
  GX_ENUM_USER_DATA_FILED_SELECTOR =
      6028 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 用户选择Flash数据区域，区域选择参考GX_USER_DATA_FILED_SELECTOR_ENTRY
  GX_BUFFER_USER_DATA_FILED_VALUE =
      6029 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 用户区内容
  GX_ENUM_FLAT_FIELD_CORRECTION =
      6030 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 平场校正开关,参考GX_FLAT_FIELD_CORRECTION_ENTRY

  //---------------UserSetControl Section-------------------------
  GX_ENUM_USER_SET_SELECTOR =
      7000 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 参数组选择,参考GX_USER_SET_SELECTOR_ENTRY
  GX_COMMAND_USER_SET_LOAD =
      7001 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 加载参数组
  GX_COMMAND_USER_SET_SAVE =
      7002 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 保存参数组
  GX_ENUM_USER_SET_DEFAULT =
      7003 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 启动参数组,参考GX_USER_SET_DEFAULT_ENTRY

  //---------------Event Section-------------------------
  GX_ENUM_EVENT_SELECTOR =
      8000 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 事件源选择,参考GX_EVENT_SELECTOR_ENTRY
  GX_ENUM_EVENT_NOTIFICATION =
      8001 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 事件使能,参考GX_EVENT_NOTIFICATION_ENTRY
  GX_INT_EVENT_EXPOSUREEND =
      8002 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 曝光结束事件ID
  GX_INT_EVENT_EXPOSUREEND_TIMESTAMP =
      8003 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 曝光结束事件时间戳
  GX_INT_EVENT_EXPOSUREEND_FRAMEID =
      8004 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 曝光结束事件帧ID
  GX_INT_EVENT_BLOCK_DISCARD =
      8005 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 数据块丢失事件ID
  GX_INT_EVENT_BLOCK_DISCARD_TIMESTAMP =
      8006 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 数据块丢失事件时间戳
  GX_INT_EVENT_OVERRUN = 8007 | GX_FEATURE_INT |
                         GX_FEATURE_LEVEL_REMOTE_DEV, ///< 事件队列溢出事件ID
  GX_INT_EVENT_OVERRUN_TIMESTAMP =
      8008 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 事件队列溢出事件时间戳
  GX_INT_EVENT_FRAMESTART_OVERTRIGGER =
      8009 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 触发信号被屏蔽事件ID
  GX_INT_EVENT_FRAMESTART_OVERTRIGGER_TIMESTAMP =
      8010 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 触发信号被屏蔽事件时间戳
  ...
  GX_INT_EVENT_BLOCK_NOT_EMPTY_TIMESTAMP =
      8012 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 帧存不为空事件时间戳
  GX_INT_EVENT_INTERNAL_ERROR =
      8013 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 内部错误事件ID
  GX_INT_EVENT_INTERNAL_ERROR_TIMESTAMP =
      8014 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 内部错误事件时间戳
  GX_INT_EVENT_FRAMEBURSTSTART_OVERTRIGGER =
      8015 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 多帧触发屏蔽事件ID
  GX_INT_EVENT_FRAMEBURSTSTART_OVERTRIGGER_FRAMEID =
      8016 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 多帧触发屏蔽事件帧ID
  GX_INT_EVENT_FRAMEBURSTSTART_OVERTRIGGER_TIMESTAMP =
      8017 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 多帧触发屏蔽事件时间戳
  GX_INT_EVENT_FRAMESTART_WAIT =
      8018 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 帧等待事件ID
  GX_INT_EVENT_FRAMESTART_WAIT_TIMESTAMP =
      8019 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 帧等待事件时间戳
  GX_INT_EVENT_FRAMEBURSTSTART_WAIT =
      8020 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 多帧等待事件ID
  GX_INT_EVENT_FRAMEBURSTSTART_WAIT_TIMESTAMP =
      8021 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 多帧等待事件时间戳
  GX_INT_EVENT_BLOCK_DISCARD_FRAMEID =
      8022 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 数据块丢失事件帧ID
  GX_INT_EVENT_FRAMESTART_OVERTRIGGER_FRAMEID =
      8023 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 触发信号被屏蔽事件帧ID
  GX_INT_EVENT_BLOCK_NOT_EMPTY_FRAMEID =
      8024 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 帧存不为空事件帧ID
  GX_INT_EVENT_FRAMESTART_WAIT_FRAMEID =
      8025 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 帧等待事件帧ID
  GX_INT_EVENT_FRAMEBURSTSTART_WAIT_FRAMEID =
      8026 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 多帧等待事件帧ID

  //---------------LUT Section-------------------------
  GX_ENUM_LUT_SELECTOR =
      9000 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 查找表选择,参考GX_LUT_SELECTOR_ENTRY
  GX_BUFFER_LUT_VALUEALL =
      9001 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 查找表内容
  GX_BOOL_LUT_ENABLE =
      9002 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 查找表使能
  GX_INT_LUT_INDEX =
      9003 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 查找表索引
  GX_INT_LUT_VALUE =
      9004 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 查找表值

  //---------------ChunkData Section-------------------------
  GX_BOOL_CHUNKMODE_ACTIVE =
      10001 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 帧信息使能
  GX_ENUM_CHUNK_SELECTOR =
      10002 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 帧信息项选择，参考GX_CHUNK_SELECTOR_ENTRY
  GX_BOOL_CHUNK_ENABLE =
      10003 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 单项帧信息使能

  //---------------Color Transformation Control-------------------------
  GX_ENUM_COLOR_TRANSFORMATION_MODE =
      11000 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 颜色转换模式，参考GX_COLOR_TRANSFORMATION_MODE_ENTRY
  GX_BOOL_COLOR_TRANSFORMATION_ENABLE =
      11001 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 颜色转换使能
  GX_ENUM_COLOR_TRANSFORMATION_VALUE_SELECTOR =
      11002 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 颜色转换矩阵元素选择，参考GX_COLOR_TRANSFORMATION_VALUE_SELECTOR_ENTRY
  GX_FLOAT_COLOR_TRANSFORMATION_VALUE =
      11003 | GX_FEATURE_FLOAT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 颜色转换矩阵元素

  //---------------CounterAndTimerControl Section-------------------------
  GX_ENUM_TIMER_SELECTOR =
      12000 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 计时器选择，参考GX_TIMER_SELECTOR_ENTRY
  GX_FLOAT_TIMER_DURATION = 12001 | GX_FEATURE_FLOAT |
                            GX_FEATURE_LEVEL_REMOTE_DEV, ///< 计时器持续时间
  GX_FLOAT_TIMER_DELAY = 12002 | GX_FEATURE_FLOAT |
                         GX_FEATURE_LEVEL_REMOTE_DEV, ///< 计时器延迟时间
  GX_ENUM_TIMER_TRIGGER_SOURCE =
      12003 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 计时器触发源，参考GX_TIMER_TRIGGER_SOURCE_ENTRY
  GX_ENUM_COUNTER_SELECTOR =
      12004 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 计数器选择，参考GX_COUNTER_SELECTOR_ENTRY
  GX_ENUM_COUNTER_EVENT_SOURCE =
      12005 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 计数器事件触发源，参考GX_COUNTER_EVENT_SOURCE_ENTRY
  GX_ENUM_COUNTER_RESET_SOURCE =
      12006 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 计数器复位源，参考GX_COUNTER_RESET_SOURCE_ENTRY
  GX_ENUM_COUNTER_RESET_ACTIVATION =
      12007 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 计数器复位信号极性，参考GX_COUNTER_RESET_ACTIVATION_ENTRY
  GX_COMMAND_COUNTER_RESET =
      12008 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 计数器复位

  //---------------RemoveParameterLimitControl Section-------------------------
  GX_ENUM_REMOVE_PARAMETER_LIMIT =
      13000 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 取消参数范围限制,
                                   ///< 参考GX_REMOVE_PARAMETER_LIMIT_ENTRY

  //////////////////////////////////////////////////////////////////////////
  /// 本地设备层(Device Feature)
  //////////////////////////////////////////////////////////////////////////
  GX_DEV_INT_COMMAND_TIMEOUT =
      0 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DEV, ///< 命令超时
  GX_DEV_INT_COMMAND_RETRY_COUNT =
      1 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DEV, ///< 命令重试次数

  //////////////////////////////////////////////////////////////////////////
  /// 流层(DataStream Feature)
  //////////////////////////////////////////////////////////////////////////
  GX_DS_INT_ANNOUNCED_BUFFER_COUNT =
      0 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 声明的Buffer个数
  GX_DS_INT_DELIVERED_FRAME_COUNT =
      1 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 接收帧个数(包括残帧)
  GX_DS_INT_LOST_FRAME_COUNT =
      2 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< buffer不足导致的丢帧个数
  GX_DS_INT_INCOMPLETE_FRAME_COUNT =
      3 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 接收的残帧个数
  GX_DS_INT_DELIVERED_PACKET_COUNT =
      4 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 接收到的包数
  GX_DS_INT_RESEND_PACKET_COUNT =
      5 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 重传包个数
  GX_DS_INT_RESCUED_PACKED_COUNT =
      6 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 重传成功包个数
  GX_DS_INT_RESEND_COMMAND_COUNT =
      7 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 重传命令次数
  GX_DS_INT_UNEXPECTED_PACKED_COUNT =
      8 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 异常包个数
  GX_DS_INT_MAX_PACKET_COUNT_IN_ONE_BLOCK =
      9 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 数据块最大重传包数
  GX_DS_INT_MAX_PACKET_COUNT_IN_ONE_COMMAND =
      10 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 一次重传命令最大包含的包数
  GX_DS_INT_RESEND_TIMEOUT =
      11 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 重传超时时间
  GX_DS_INT_MAX_WAIT_PACKET_COUNT =
      12 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 最大等待包数
  GX_DS_ENUM_RESEND_MODE =
      13 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_DS, ///< 重传模式,参考GX_DS_RESEND_MODE_ENTRY
  GX_DS_INT_MISSING_BLOCKID_COUNT =
      14 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< BlockID丢失个数
  GX_DS_INT_BLOCK_TIMEOUT =
      15 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 数据块超时时间
  GX_DS_INT_STREAM_TRANSFER_SIZE =
      16 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 传输数据块大小
  GX_DS_INT_STREAM_TRANSFER_NUMBER_URB =
      17 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 传输数据块数量
  GX_DS_INT_PACKET_TIMEOUT =
      19 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS, ///< 包超时时间
  ...
  GX_STRING_DEVICE_ID =
      4 | GX_FEATURE_STRING |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 设备序列号[弃用，改用GX_STRING_DEVICE_SERIAL_NUMBER]
  GX_STRING_DEVICE_HARDWARE_VERSION =
      5 | GX_FEATURE_STRING |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 设备硬件版本[弃用]
  GX_INT_GAIN = 5002 | GX_FEATURE_INT |
                GX_FEATURE_LEVEL_REMOTE_DEV, ///< 增益[弃用，改用GX_FLOAT_GAIN]
  GX_INT_BLACKLEVEL =
      5005 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 黑电平[弃用，改用GX_FLOAT_BLACKLEVEL]
  GX_FLOAT_BALANCE_RATIO_SELECTOR =
      5007 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 白平衡通道选择[弃用，改用GX_ENUM_BALANCE_RATIO_SELECTOR]
  GX_ENUM_AA_LIGHT_ENVIRMENT =
      6007 | GX_FEATURE_ENUM |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动曝光、自动增益，光照环境类型[弃用，改用GX_ENUM_AA_LIGHT_ENVIRONMENT]
  GX_INT_ROI_X =
      6008 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动调节感兴趣区域X坐标[弃用，改用GX_INT_AAROI_OFFSETX]
  GX_INT_ROI_Y =
      6009 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动调节感兴趣区域Y坐标[弃用，改用GX_INT_AAROI_OFFSETY]
  GX_INT_ROI_WIDTH =
      6010 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动调节感兴趣区域宽度[弃用，改用GX_INT_AAROI_WIDTH]
  GX_INT_ROI_HEIGHT =
      6011 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动调节感兴趣区域高度[弃用，改用GX_INT_AAROI_HEIGHT]
  GX_INT_AUTO_GAIN_VALUEMIN =
      6012 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动增益最小值[弃用，改用GX_FLOAT_AUTO_GAIN_MIN]
  GX_INT_AUTO_GAIN_VALUEMAX =
      6013 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动增益最大值[弃用，改用GX_FLOAT_AUTO_GAIN_MAX]
  GX_INT_AUTO_SHUTTER_VALUEMIN =
      6014 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动曝光最小值[弃用，改用GX_FLOAT_AUTO_EXPOSURE_TIME_MIN]
  GX_INT_AUTO_SHUTTER_VALUEMAX =
      6015 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 自动曝光最大值[弃用，改用GX_FLOAT_AUTO_EXPOSURE_TIME_MAX]
  GX_INT_CONTRASTPARAM =
      6017 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 对比度参数[弃用，改用GX_INT_CONTRAST_PARAM]
  GX_FLOAT_GAMMAPARAM =
      6018 | GX_FEATURE_FLOAT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 伽马参数[弃用，改用GX_FLOAT_GAMMA_PARAM]
  GX_INT_COLORCORRECTIONPARAM =
      6019 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_REMOTE_DEV, ///< 颜色校正系数[弃用，改用GX_INT_COLOR_CORRECTION_PARAM]
  GX_DS_INT_MAX_NUM_QUEUE_BUFFER =
      18 | GX_FEATURE_INT |
      GX_FEATURE_LEVEL_DS, ///< 采集队列最大Buffer个数[弃用，可选择使用GXSetAcqusitionBufferNumber接口设置采集buffer个数]
...
//------------------------------------------------------------------------------
typedef void *
    GX_DEV_HANDLE; ///< 设备句柄，通过GXOpenDevice获取，通过此句柄进行控制与采集
typedef void *
...
typedef enum GX_PIXEL_FORMAT_ENTRY {
  ...
  GX_PIXEL_FORMAT_MONO8 =
      (GX_PIXEL_MONO | GX_PIXEL_8BIT | 0x0001), // 0x1080001,
  GX_PIXEL_FORMAT_MONO8_SIGNED =
      (GX_PIXEL_MONO | GX_PIXEL_8BIT | 0x0002), // 0x1080002,
  GX_PIXEL_FORMAT_MONO10 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x0003), // 0x1100003,
  GX_PIXEL_FORMAT_MONO12 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x0005), // 0x1100005,
  GX_PIXEL_FORMAT_MONO14 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x0025), // 0x1100025,
  GX_PIXEL_FORMAT_MONO16 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x0007), // 0x1100007,
  GX_PIXEL_FORMAT_BAYER_GR8 =
      (GX_PIXEL_MONO | GX_PIXEL_8BIT | 0x0008), // 0x1080008,
  GX_PIXEL_FORMAT_BAYER_RG8 =
      (GX_PIXEL_MONO | GX_PIXEL_8BIT | 0x0009), // 0x1080009,
  GX_PIXEL_FORMAT_BAYER_GB8 =
      (GX_PIXEL_MONO | GX_PIXEL_8BIT | 0x000A), // 0x108000A,
  GX_PIXEL_FORMAT_BAYER_BG8 =
      (GX_PIXEL_MONO | GX_PIXEL_8BIT | 0x000B), // 0x108000B,
  GX_PIXEL_FORMAT_BAYER_GR10 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x000C), // 0x110000C,
  GX_PIXEL_FORMAT_BAYER_RG10 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x000D), // 0x110000D,
  GX_PIXEL_FORMAT_BAYER_GB10 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x000E), // 0x110000E,
  GX_PIXEL_FORMAT_BAYER_BG10 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x000F), // 0x110000F,
  GX_PIXEL_FORMAT_BAYER_GR12 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x0010), // 0x1100010,
  GX_PIXEL_FORMAT_BAYER_RG12 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x0011), // 0x1100011,
  GX_PIXEL_FORMAT_BAYER_GB12 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x0012), // 0x1100012,
  GX_PIXEL_FORMAT_BAYER_BG12 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x0013), // 0x1100013,
  GX_PIXEL_FORMAT_BAYER_GR16 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x002E), // 0x110002E,
  GX_PIXEL_FORMAT_BAYER_RG16 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x002F), // 0x110002F,
  GX_PIXEL_FORMAT_BAYER_GB16 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x0030), // 0x1100030,
  GX_PIXEL_FORMAT_BAYER_BG16 =
      (GX_PIXEL_MONO | GX_PIXEL_16BIT | 0x0031), // 0x1100031,
  GX_PIXEL_FORMAT_RGB8_PLANAR =
      (GX_PIXEL_COLOR | GX_PIXEL_24BIT | 0x0021), // 0x2180021,
  GX_PIXEL_FORMAT_RGB10_PLANAR =
      (GX_PIXEL_COLOR | GX_PIXEL_48BIT | 0x0022), // 0x2300022,
  GX_PIXEL_FORMAT_RGB12_PLANAR =
      (GX_PIXEL_COLOR | GX_PIXEL_48BIT | 0x0023), // 0x2300023,
  GX_PIXEL_FORMAT_RGB16_PLANAR =
      (GX_PIXEL_COLOR | GX_PIXEL_48BIT | 0x0024), // 0x2300024,
...
typedef struct GX_DEVICE_IP_INFO {
  char szDeviceID
      [GX_INFO_LENGTH_64_BYTE +
       4]; ///< 设备唯一标识,如果实际长度超过64字节有效字符串，则只保留64个有效字符
  char szMAC
      [GX_INFO_LENGTH_32_BYTE]; ///< MAC地址,如果实际长度超过32字节有效字符串，则只保留31个有效字符
  char szIP
      [GX_INFO_LENGTH_32_BYTE]; ///< IP地址,如果实际长度超过32字节有效字符串，则只保留31个有效字符
  char szSubNetMask
      [GX_INFO_LENGTH_32_BYTE]; ///< 子网掩码,如果实际长度超过32字节有效字符串，则只保留31个有效字符
  char szGateWay
      [GX_INFO_LENGTH_32_BYTE]; ///< 网关,如果实际长度超过32字节有效字符串，则只保留31个有效字符
  char szNICMAC
      [GX_INFO_LENGTH_32_BYTE]; ///< 对应网卡的MAC地址,如果实际长度超过32字节有效字符串，则只保留31个有效字符
  char szNICIP
      [GX_INFO_LENGTH_32_BYTE]; ///< 对应网卡的IP地址,如果实际长度超过32字节有效字符串，则只保留31个有效字符
  char szNICSubNetMask
      [GX_INFO_LENGTH_32_BYTE]; ///< 对应网卡的子网掩码,如果实际长度超过32字节有效字符串，则只保留31个有效字符
  char szNICGateWay
      [GX_INFO_LENGTH_32_BYTE]; ///< 对应网卡的网关,如果实际长度超过32字节有效字符串，则只保留31个有效字符
  char szNICDescription
      [GX_INFO_LENGTH_128_BYTE +
       4]; ///< 对应网卡描述,如果实际长度超过128字节有效字符串，则只保留128个有效字符
  char reserved[512]; ///< 保留
} GX_DEVICE_IP_INFO;

typedef struct GX_DEVICE_BASE_INFO {
  char szVendorName
      [GX_INFO_LENGTH_32_BYTE]; ///< 厂商名称,如果实际长度超过32字节有效字符串，则只保留31个有效字符
  char szModelName
      [GX_INFO_LENGTH_32_BYTE]; ///< 设备类型名称,如果实际长度超过32字节有效字符串，则只保留31个有效字符
  char szSN
      [GX_INFO_LENGTH_32_BYTE]; ///< 设备序列号,如果实际长度超过32字节有效字符串，则只保留31个有效字符
  char szDisplayName
      [GX_INFO_LENGTH_128_BYTE +
       4]; ///< 设备展示名称,如果实际长度超过128字节有效字符串，则只保留128个有效字符
  char szDeviceID
      [GX_INFO_LENGTH_64_BYTE +
       4]; ///< 设备唯一标识,如果实际长度超过64字节有效字符串，则只保留64个有效字符
  char szUserID
      [GX_INFO_LENGTH_64_BYTE +
       4]; ///< 用户自定义名称,如果实际长度超过64字节有效字符串，则只保留64个有效字符
...
typedef struct GX_FRAME_CALLBACK_PARAM {
  ...
  const void *pImgBuf;    ///< 图像buffer地址（开启chunkdata后，pImgBuf
                          ///< 包含图像数据和帧信息数据 ）
  int32_t
...
*/
//----------------------------------------------------------------------------------
typedef void(GX_STDC *GXFeatureCallBack)(GX_FEATURE_ID_CMD nFeatureID,
                                         void *pUserParam);
...
\brief     初始化设备库。
\attention
调用其他接口（除了GXGetLastError和GXCloseLib）之前必须先调用此接口，当用户不再使用库的时候调用GXCloseLib释放库资源。
...
\brief       获取程序最后的错误描述信息
\attention
当用户调用其它接口失败的时候，可以调用此接口获取关于失败信息的详细描述
\param [out] pErrorCode
返回最后的错误码，如果用户不想获取此值，那么此参数可以传NULL
...
*/
//----------------------------------------------------------------------------------
GX_API GXOpenDeviceByIndex(uint32_t nDeviceIndex,
                           GX_DEV_HANDLE *phDevice); // 已弃用
...
用户传入非法的句柄，或者关闭已经被关闭的设备 其它错误情况请参见GX_STATUS_LIST
*/
//----------------------------------------------------------------------------------
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetDevicePersistentIpAddress(GX_DEV_HANDLE hDevice, char *pszIP,
                                      size_t *pnIPLength, char *pszSubNetMask,
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetFeatureName(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                        char *pszName, size_t *pnSize);

//----------------------------------------------------------------------------------
/**
\brief      查询当前相机是否支持某功能
\attention  不支持某功能有两个情况：
1、通过查询相机寄存器，查到当前相机当前不支持此功能
...
*/
//----------------------------------------------------------------------------------
GX_API GXIsImplemented(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
...
\brief      查询某功能码当前是否可读
\attention
某些功能的可读属性是随着其它节点的当前值改变的，可用此接口实时查询功能当前是否可读
\param [in]hDevice 设备句柄
\param [in]featureID 功能码ID
\param [out]pbIsReadable
用来返回结果，如果可读则返回true，如果不可读则返回false。
\return    GX_STATUS_SUCCESS             操作成功，没有发生错误
           GX_STATUS_NOT_INIT_API        没有调用GXInitLib初始化库
                   GX_STATUS_INVALID_HANDLE      用户传入非法的句柄
...
*/
//----------------------------------------------------------------------------------
GX_API GXIsReadable(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                    bool *pbIsReadable);
...
\brief      查询某功能码当前是否可写
\attention
某些功能的可写属性是随着其它节点的当前值改变的，可用此接口实时查询功能当前是否可写
\param [in]hDevice 设备句柄
\param [in]featureID 功能码ID
\param [out]pbIsWritable
用来返回结果，如果可写则返回true，如果不可写则返回false。
\return    GX_STATUS_SUCCESS             操作成功，没有发生错误
           GX_STATUS_NOT_INIT_API        没有调用GXInitLib初始化库
                   GX_STATUS_INVALID_HANDLE      用户传入非法的句柄
                   GX_STATUS_NOT_IMPLEMENTED     当前不支持的功能
...
*/
//----------------------------------------------------------------------------------
GX_API GXIsWritable(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                    bool *pbIsWritable);
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetIntRange(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetInt(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                int64_t *pnValue);
...
*/
//----------------------------------------------------------------------------------
GX_API GXSetInt(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                int64_t nValue);
...
*/
//----------------------------------------------------------------------------------
GX_API GXSetFloat(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                  double dValue);
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetFloat(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                  double *pdValue);
...
\brief      获取枚举类型值有多少项
\attention
某枚举功能类型的项数是需要查询的，头文件中所罗列的是所有可能的项，但是
...
\attention
用户做UI程序的时候需要枚举功能项的描述信息；枚举功能项的值建议用户先查
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetEnum(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                 int64_t *pnValue);
...
*/
//----------------------------------------------------------------------------------
GX_API GXSetEnum(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                 int64_t nValue);
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetBool(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                 bool *pbValue);
...
*/
//----------------------------------------------------------------------------------
GX_API GXSetBool(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                 bool bValue);
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetStringLength(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                         size_t *pnSize);
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetStringMaxLength(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                            size_t *pnSize);
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetString(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                   char *pszContent, size_t *pnSize);
...
*/
//----------------------------------------------------------------------------------
GX_API GXSetString(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                   char *pszContent);
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetBufferLength(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
                         size_t *pnSize);
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetBuffer(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
...
*/
//----------------------------------------------------------------------------------
GX_API GXSetBuffer(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID,
...
\return    GX_STATUS_SUCCESS             操作成功，没有发生错误
           GX_STATUS_NOT_INIT_API        没有调用GXInitLib初始化库
                   ...
                   GX_STATUS_NEED_MORE_BUFFER
用户分配的图像buffer小于实际需要的大小 其它错误情况请参见GX_STATUS_LIST
*/
//----------------------------------------------------------------------------------
...
\brief      清空采集输出队列
\attention
如果用户处理图像的速度较慢，库内会残留上次采集过程的缓存图像，特别在触发模式下，
...
\brief      注册事件回调函数
\attention
设备事件比如，掉线事件、曝光结束等，这些事件都可以通过这个接口的回调方式传出，
...
\return    GX_STATUS_SUCCESS             操作成功，没有发生错误
           GX_STATUS_NOT_INIT_API        没有调用GXInitLib初始化库
                   GX_STATUS_INVALID_HANDLE      用户传入非法的句柄
                   GX_STATUS_INVALID_PARAMETER
用户传入回调函数非法或者传入事件类型非法 其它错误情况请参见GX_STATUS_LIST
*/
//----------------------------------------------------------------------------------
...
\brief      清空事件输出队列
\attention
库内部事件数据的接收和处理采用缓存机制，如果用户接收、处理事件的速度慢于事件产生的速度，
...
\brief      注销属性更新回调函数
\attention
与GXRegisterFeatureCallback配套使用，每次注册都必须有相应的注销与之对应
\param [in]hDevice     设备句柄
\param [in]featureID   功能码
\param [out]pHCallBack  回调函数句柄
\return    GX_STATUS_SUCCESS             操作成功，没有发生错误
...
*/
//----------------------------------------------------------------------------------
GX_API GXImportConfigFileW(GX_DEV_HANDLE hDevice, const wchar_t *pszFilePath,
                           bool bVerify = false);
...
*/
//----------------------------------------------------------------------------------
GX_API GXWriteRemoteDevicePort(GX_DEV_HANDLE hDevice, uint64_t ui64Address,
